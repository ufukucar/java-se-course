...
/*
        ...
        List<String> liste4 = new LinkedList<>();
...
*/
        ...
        //Collections.sort(liste2); // listede null değeri varsa hata verir.
        //System.out.println("Liste2 elemanları SIRALANMIŞ: " + liste2);
        System.out.println("-----------------------------");


        for (String isim : liste2 ) {
            System.out.println(isim);
        }
        System.out.println("-----------------------------");

        System.out.println("İlk kayıt: " + liste2.getFirst());
        System.out.println("Son kayıt: " + liste2.getLast());
